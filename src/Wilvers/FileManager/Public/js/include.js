    ...
    e(document).ready(function () {
        ...
        if (U.makeSort(t), U.makeFilters(t), e("#info").on("click", function () {
            ...
            e("#view").val(t),
                    ...
                    a.attr("data-value") >= 1 ? m(14) : (e("ul.grid li").css("width", 126), e("ul.grid figure").css("width", 122)),
                    C()
        ...
        e(window).resize(function () {
            ...
            apply = function (a, t) {
                ...
                if ("" != t)
                    ...
                    e.inArray(c, ext_img) > -1 ? s = '<img src="' + u + '" alt="' + l + '" />' : e.inArray(c, p) > -1 ? s = '<video controls source src="' + u + '" type="video/' + c + '">' + l + "</video>" : e.inArray(c, d) > -1 ? ("mp3" == c && (c = "mpeg"), s = '<audio controls src="' + u + '" type="audio/' + c + '">' + l + "</audio>") : s = '<a href="' + u + '" title="' + l + '">' + l + "</a>", 1 == e("#crossdomain").val() ? n.postMessage({
                        sender: "responsivefilemanager",
                        url: u,
                        field_id: null,
                        html: s
